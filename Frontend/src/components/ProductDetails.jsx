...
import { Edit, Trash2, X, Plus, XCircle, Save, ChevronLeft } from "lucide-react";
...
export default function ProductDetail() {
  ...
  const fetchMockData = async (id) => {
    const data = mock_cars.find((car) => car.id === id);
    setCar({
      ...data,
    });
        ...
        {car.isEditing ? (
          <div className="">
            <h1 className="text-4xl flex items-center gap-4 font-bold mb-6 text-gray-900">
              <div className="flex items-center justify-center w-12 h-12 bg-blue-600 text-white rounded-full cursor-pointer"
